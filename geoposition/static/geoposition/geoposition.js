...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Binding Add Row Inline
        $('.geoposition-widget').parent().parent().parent().parent().parent()
            .children(".add-row").children().click(function () {
            // And try initialize again for new row
            initializeMap();
        });
        ...
        function initializeMap() {
            $('.geoposition-widget').each(function () {
                ...
                // Already initialize
                if ($container.data('map-widget-init') == "true") {
                    return;
                }

                if ($container.parent().parent().parent().parent().hasClass("empty-form")) {
                    // This is empty-form, pre-created element so we skip it
                    return;
                } else {
                    // Mark this widget is initialized
                    $container.data('map-widget-init', "true");
                }
