...
from .custom_map import Options
...
class MapOnlyWidget(forms.MultiWidget):
    def __init__(self, attrs=None):
        widgets = (
            forms.TextInput(),
            forms.TextInput(),
        )
        super(MapOnlyWidget, self).__init__(widgets, attrs)
...
class AdjustableMapOnlyWidget(forms.MultiWidget):
    def __init__(self, attrs=None):
        widgets = (
            forms.TextInput(),
            forms.TextInput(),
    ...
    def format_output(self, rendered_widgets):
        return render_to_string('geoposition/widgets/adjustable-map-only.html', {
            'latitude': {
                'html': rendered_widgets[0],
                'label': _("latitude"),
            },
